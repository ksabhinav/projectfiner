...
# try these alternative categories.
#
# NOTE: A more comprehensive no-DB regenerator is available at
# db/regenerate_indicator_files_from_states.py — it reads directly from
# public/slbc-data/<state>/<state>_fi_timeseries.json and applies a broader
# field+category fallback chain that captures variants seen across all
# 23 state extractors (housing_finance, housing_loan, stand_up_india_p2,
# pmegp_3/4, social_security_schemes_2, mudra/pmmy/pmmy_mudra prefixes, etc.).
# Run that when extending coverage without rebuilding finer.db.
CROSS_CATEGORY_FALLBACKS = {
    ...
    'kcc': ['fi_kcc', 'kcc_animal_husbandry', 'kcc_fishery', 'kcc_outstanding',
            'kcc_outstanding_2', 'kcc_outstanding_3', 'kcc_outstanding_4', 'kcc_fisheries'],
    'shg': ['shg_nrlm', 'nrlm', 'shg_p2', 'shg_p3', 'jlg'],
    'digital_transactions': ['digital_transactions_2', 'phonepe_upi', 'digital_payments',
                             'digital_coverage_savings', 'digital_coverage_savings_p2',
                             'digital_coverage_savings_p3', 'digital_coverage_savings_p4',
                             'digital_coverage_business', 'women_finance'],
    'social_security': ['social_security_2', 'social_security_3',
    ...
    'pmjdy': ['pmjdy_p2', 'pmjdy_p3', 'pmjdy_p4', 'social_security_schemes',
              'pmjdy_2', 'pmjdy_3'],
    ...
    'sc_st_finance': ['sc_st_finance_2', 'sc_st_finance_p2', 'sc_st_lending',
                       'sc_st_loans', 'weaker_section', 'weaker_section_os'],
    'women_finance': ['women_finance_2', 'women_finance_p2'],
    'education_loan': ['education_loan_2'],
    'pmmy_mudra_disbursement': ['pmmy_mudra_disbursement_2', 'pmmy_mudra_os_npa',
                                 'pmmy_mudra', 'pmmy', 'mudra', 'mudra_2', 'mudra_outstanding'],
}
